...
<div class="buttons">
    <div class="pull-right">
        <input style="display:none;" id="click-subscription-pay" type="submit" onclick="razorpaySubscriptionSubmit(this);" value="<?php echo $button_confirm; ?>" class="btn btn-primary" />
    </div>
</div>
...
jQuery("#click-subscription-pay").trigger("click");
</script>